...
<div class="container my-5">
  <div class="row g-4">
    ...
    <div class="col-12 col-md-6">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-header bg-white  py-3 border-bottom">
          <h5 class="card-title mb-0 fw-semibold text-primary">Profile Details</h5>
        </div>
        <div class="card-body">
          <form id="profileForm">
            <!-- Name -->
            ...
            <div class="text-end mt-4">
              <button id="updateProfile" type="submit" class="btn btn-primary px-4">Update Profile</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="col-12 col-md-6">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom">
          <h5 class="card-title mb-0 fw-semibold text-danger">Reset Password</h5>
        </div>
